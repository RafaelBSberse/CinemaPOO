...
public class InterfaceDeUsuario {
    ...
    private static void setFuncionarios() {
        ...
        System.out.println("Digite o CPF do Funcion�rio (999.999.999-99): ");
        String cpf = leitor.nextLine();
        System.out.println("Digite a Data de Admiss�o do Funcion�rio (dd/mm/YYYY): ");
    ...
    private static void getFuncionarios(){
    	if(funcionarios.size() == 0) {
    		...
    		funcionarios.forEach((n) -> {
    			System.out.println("\tFuncion�rio " + (funcionarios.indexOf(n) + 1)); 
        		n.getFuncionario();
        		System.out.println(); 
        	});
    	}
    ...
    private static void setHorarios() {
    	...
    	if(funcionariosSelecionados.size() < 4) {
    		System.out.println();
    		System.out.println("Funcionarios Insuficientes (Menos do que 4 selecionados). Cancelando opera��o!");
    	} else {
    		System.out.println();
    		String horario = "";
    		...
    		while(true) {
    			System.out.println("Selecione um dos Hor�rios: \n1. 16h\n2. 18h\n3. 20h\n4. 22h\n5. 24h"); 
    			System.out.print("Op��o: "); 
    			...
    			if(horario.equals("")) {
    				System.out.println("Hor�rio Invalido. Tente novamente ou digite \"Sair\" para cancelar a opera��o."); 
    			} else {
    				break;
    			}
    		}
    ...
    private static void addFilmeNaSala(){
        ...
        while(true) {
        	...
        	if(!achouSala) {
        		System.out.println("Sala n�o encontrado. Tente novamente ou digite \"Sair\" para cancelar a opera��o."); 
        		System.out.println(); 
        	} else {
        		break;
        	}
        ...
        if(salaSelecionada == null) {
        	...
        	while(true) {
        		...
        		if(!achouFilme) {
        			System.out.println("Filme n�o encontrado. Tente novamente ou digite \"Sair\" para cancelar a opera��o."); 
        			System.out.println(); 
        		} else {
        			break;
        		}
        	...
        	if(filmeSelecionado == null) {
        		...
        		if(horarios.size() > 0) {
        			while(true) {
        				System.out.println("Selecione um horario (Caso o horario desejado n�o esteja presente, define o conjunto de funcionarios para o mesmo): ");
        			...
        			System.out.print("N�o h� nenhum hor�rio cadastrado. Para cadastra-los, defina o conjunto de funcionarios para o mesmo. Cancelando Opera��o");
        		}
        	}
        }
    }
